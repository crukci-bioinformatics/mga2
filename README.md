...
5. Run MGA specifying the configuration file and, optionally, a release version and an execution profile
    ...
    `nextflow run crukci-bioinformatics/mga2 -r 2.0.6 -c mga.config -profile cluster`
...
`nextflow pull` as follows:
    ...
    nextflow pull crukci-bioinformatics/mga2 -r 2.0.6
...
to be specified when running the pipeline using `nextflow run`.
    ...
    nextflow run crukci-bioinformatics/mga2 -r 2.0.6 -c mga.config -profile myprofile
